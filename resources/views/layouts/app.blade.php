...
<div id="content">
    ...
    <header id="topbar" style="display:flex;align-items:center;justify-content:space-between;padding:0 20px;position:sticky;top:0;z-index:30;">
        ...
        <div style="position:relative;" id="userMenuWrap">
            ...
            <div id="userMenu"
                 style="display:none;position:absolute;right:0;top:48px;background:white;border-radius:8px;box-shadow:0 4px 20px rgba(0,0,0,0.12);border:1px solid #eee;min-width:170px;z-index:50;">
